                 ...
                 <div class="col-lg-12">
                     <div class="slider-activation axil-slick-arrow">
                         ...
                         @foreach ($getTodayDevotion as $output)
                             ...
                             <div class="post-thumbnail">
                                 <a href="post-details.html">
                                     <img class="img-fluid" src="assets/images/slides/dev1.png" alt="Post Images">
                                 </a>
                             </div>
                             <!-- End Post Thumbnail  -->
                         ...
                         <div class="content-block">
                             ...
                             <div class="post-thumbnail">
                                 <a href="post-details.html">
                                     <img class="img-fluid" src="assets/images/slides/dev2.jpg" alt="Post Images">
                                 </a>
                             </div>
                             <!-- End Post Thumbnail  -->
                             <!-- Start Post Content  -->
                             <div class="post-content">
                                 ...
                                 <h2 class="title"><a href="post-details.html">God Can Never Leave You</a></h2>
