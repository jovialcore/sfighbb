...
<!-- Start Banner Area -->
<div class="banner banner-single-post post-layout-3 post-formate post-standard bg_image bg_image--2 d-flex align-items-end" style="background-image: url('{{ $posts->thumbnail }}')">
    <div class="container">
        <div class="row">
