                            ...
                            <div class="post-cat-list">
                                <a class="hover-flip-item-wrapper" href="#">
                                    <span class="hover-flip-item">
                                        <span data-text="Searching for Gods heartbeat">Searching for Gods heartbeat</span>
                                    </span>
                                </a>
                            </div>
                        </div>
                        <h1 class="title">{{ $devotion->title }}</h1>
                        <!-- Post Meta  -->
                            ...
                            <div class="post-meta">
                                ...
                                <div class="content">
                                    ...
                                    <ul class="post-meta-list">
                                        <li>{{ Carbon\Carbon::parse($devotion['release_date'])->toFormattedDateString() }}</li>
            ...
            <div class="col-lg-10 offset-lg-1">
                <div class="axil-post-details">
                    ...
                    <div style="margin-top: 10px; margin-bottom:10px">
                        <p>{!! $devotion->bible_reading !!}</p>
                    </div>

                    <p style="line-height: 2.5em; text-align: justify; text-indent: 30px">{!! $devotion->story !!}</p>
                    ...
                    @include('sniffets.comments', $comments)
